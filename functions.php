...
function simplenews_enqueue_style(){
   ...
   wp_enqueue_script('Lightbox',get_template_directory_uri()."/js/simpleLightbox.min.js");
...
add_action( 'wp_enqueue_scripts', 'simplenews_enqueue_style' );
...
function simplenews_register_entrevue_post_type()
{
	$labels = [
		...
		'not_found'                => __("Aucune entrevue n'a été trouvé", "simplenews"),
		...
		'set_featured_image'       => __("Assigner l'image a entrevue", "simplenews"),
